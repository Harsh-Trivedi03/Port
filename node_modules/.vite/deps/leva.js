...
function create(createState) {
  ...
  const useStore = (selector = api.getState, equalityFn = Object.is) => {
    const [, forceUpdate] = (0, import_react6.useReducer)((c5) => c5 + 1, 0);
    const state = api.getState();
    const stateRef = (0, import_react6.useRef)(state);
    const selectorRef = (0, import_react6.useRef)(selector);
    const equalityFnRef = (0, import_react6.useRef)(equalityFn);
    const erroredRef = (0, import_react6.useRef)(false);
    const currentSliceRef = (0, import_react6.useRef)();
    ...
    const stateBeforeSubscriptionRef = (0, import_react6.useRef)(state);
    useIsomorphicLayoutEffect(() => {
      const listener = () => {
        try {
    ...
    (0, import_react6.useDebugValue)(sliceToReturn);
